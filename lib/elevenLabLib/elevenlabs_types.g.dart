...
Voice _$VoiceFromJson(Map<String, dynamic> json) => Voice(
  availableForTiers:
      (json['available_for_tiers'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
...
FineTuning _$FineTuningFromJson(Map<String, dynamic> json) => FineTuning(
  ...
  fineTuningState: const FineTuningStateConverter().fromJson(
    json['finetuning_state'] as String,
  ),
  ...
  modelId: json['model_id'] as String?,
  sliceIds:
      (json['slice_ids'] as List<dynamic>?)?.map((e) => e as String).toList(),
  verificationAttempts:
      (json['verification_attempts'] as List<dynamic>?)
  ...
  verificationFailures:
      (json['verification_failures'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
...
Map<String, dynamic> _$FineTuningToJson(FineTuning instance) =>
    <String, dynamic>{
      ...
      'finetuning_state': const FineTuningStateConverter().toJson(
...
AddVoiceResponse _$AddVoiceResponseFromJson(Map<String, dynamic> json) =>
    AddVoiceResponse(voiceId: json['voice_id'] as String);

Map<String, dynamic> _$AddVoiceResponseToJson(AddVoiceResponse instance) =>
    <String, dynamic>{'voice_id': instance.voiceId};
...
HistoryItem _$HistoryItemFromJson(Map<String, dynamic> json) => HistoryItem(
  ...
  characterCountChangeTo: (json['character_count_change_to'] as num).toInt(),
...
DownloadHistoryItemsRequest _$DownloadHistoryItemsRequestFromJson(
  ...
  historyItemIds:
      (json['history_item_ids'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
);
...
) => <String, dynamic>{'history_item_ids': instance.historyItemIds};
...
ExtendedSubscriptionInfo _$ExtendedSubscriptionInfoFromJson(
  ...
  nextInvoice: NextInvoice.fromJson(
    json['next_invoice'] as Map<String, dynamic>,
  ),
  professionalVoiceLimit: (json['professional_voice_limit'] as num).toInt(),
  status: json['status'] as String,
  tier: json['tier'] as String,
...
NextInvoice _$NextInvoiceFromJson(Map<String, dynamic> json) => NextInvoice(
  ...
  nextPaymentAttemptUnix: (json['next_payment_attempt_unix'] as num).toInt(),
);
