...
class YoutubeSummaryView extends GetView<YoutubeSummaryController> {
  const YoutubeSummaryView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<YoutubeSummaryController>(
      init: YoutubeSummaryController(),
      builder: (controller) {
        return CommonScreen(
                        ...
                        ListView(
                          ...
                          children: [
                            CommonQuestionView(
                              ...
                              answerImageUrl: controller.image.value,
                              ansTitle: controller.title.value,
                              ansSubTitle: controller.url.value,
                            ),
                            ListView.builder(
                              shrinkWrap: true,
                              primary: false,
                                ...
                                return chatQuestionAnsView(
                                  ...
                                  suggestionOnTap: (data) {
                                    ChatApi().apiCalling(
                                      ...
                                      scrollController: controller.scrollController,
                                      modelTitle: Constants.youtubeSummaryType,
                                      systemText: controller.qq,
                                      fileName: controller.title.value,
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (BuildContext context, int index) {
                                      return GestureDetector(
                                        onTap: () async {
                                          // ChatApi().apiCalling(
                                          //   textQuestion: controller.promptList[index],
                                          //   chatItem: controller.chatItem,
                                          //   scrollController: controller.scrollController,
                                          //   modelTitle: Constans.youtubeSummary,
                                          // );
                ...
                CommonTextField(
                  ...
                  onStop: () async {
                    ...
                    await modelsHistoryAPI(
                      controller.chatItem,
                      "",
                      Constants.youtubeSummaryType,
                      fileName: controller.title.value,
                      fileText: controller.url.value,
                    );
